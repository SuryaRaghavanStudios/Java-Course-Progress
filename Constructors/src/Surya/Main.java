...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // * 2. To allow the customer to withdraw funds. This should deduct from the balance field, but not allow the
        // * withdrawal to complete if they are insufficient funds.
